...
$query = "SELECT 
          ...
          WHERE 
            r.medecin_valid IS NULL 
            AND r.id_resid = (SELECT id FROM members WHERE username = '" . mysqli_real_escape_string($conn, $_SESSION['username']) . "')";
